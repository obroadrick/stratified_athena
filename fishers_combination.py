...
def simulate_fisher_combined_audit_minerva(N_w1, N_l1, N1, N_w2, N_l2, N2, n1, n2, alpha,
...
def minerva_pvalue(sample, popsize, alpha, Vw, Vl, null_margin):
    """Computes the pvalue for a minerva audit of the passed values.
    ...
    #print("N: "+str(popsize)+", null_margin: "+str(null_margin)+", x*: "+str((popsize + null_margin) / 2)+", n: "+str(n)+", k: "+str(k)+", pvalue: "+str(pvalue))
    return min([pvalue,1])
