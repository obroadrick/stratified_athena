...
class Audit_S(ABC):
    ...
    def __init__(self, alpha: float, beta: float, max_fraction_to_draw: float, replacement: bool, contest: Contest, null_margin: int = 0):
        ...
        if type(beta) is not float: raise TypeError('beta must be a float.')
